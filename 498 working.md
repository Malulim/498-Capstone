...
*   **Rationale:** Development and verification speed represent the binding constraints because the pipeline cycle budget closes comfortably. Standard engineering literature[cite: 6] supports instantiating off-the-shelf cores over custom layout verification.
